...
<body>
    ...
    <section class="position-relative pt-48 pb-40 bg-dark bg-cover bg-size--cover" style="background-image:url(https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1950&q=80)">
    <!-- Overlay -->
            ...
            <div class="row">
                <div class="col">
                    <div class="autocomplete">
                        <input type="text" id="search-bar" class="form-control" name="search" autocomplete="off" placeholder="Attraction search..." minlength="2">
                    </div>
